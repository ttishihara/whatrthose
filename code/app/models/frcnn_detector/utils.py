...
def get_data(input_path):
    ...
    with open(input_path, 'r') as f:
        ...
        for line in f:
            ...
            #    x1, y1, x2, y2 are the pixel value of the origial image, not
            # the ratio value
            #    (x1, y1) top left coordinates; (x2, y2) bottom right
            #    coordinates
            #   x1,y1-------------------
            #    |                        |
            #    |                        |
            ...
            if class_name not in class_mapping:
                if class_name == 'bg' and found_bg == False:
                    print(
                        'Found class name with special name bg. Will be'
                        'treated as a background region (this is usually for'
