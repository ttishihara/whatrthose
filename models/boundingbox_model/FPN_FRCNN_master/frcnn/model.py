...
#                                 use_mini_mask=config.USE_MINI_MASK)
            ...
            if random_rois:
                ...
                if detection_targets:
                    rois, FRCNN_class_ids, FRCNN_bbox, FRCNN_mask =\
...
#                         batch_FRCNN_mask = np.zeros(
#                             (batch_size,) + FRCNN_mask.shape, dtype=FRCNN_mask.dtype)
...
#                         outputs.extend(
#                             [batch_FRCNN_class_ids, batch_FRCNN_bbox, batch_FRCNN_mask])
                        outputs.extend(
